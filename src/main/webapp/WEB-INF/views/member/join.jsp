...
<body>
	...
	$(document).ready(function(){
			$(".join_button").click(function() {
				 console.log("클릭되었음");
				 console.log(idCheck, idckCheck, pwCheck, pwckCheck, pwckcorCheck, nameCheck, mailCheck, mailnumCheck, addressCheck);
				/* 입력값 변수 */
		...
		$(".pwck_input").on("propertychange change keyup paste input",function(){
			...
			if(pw == pwck){
				...
				$(".pwck_input_re_1").css("display", "nonea");
				pwckcorCheck = false;
			}
		...
		$(".mail_check_button").click(function() {
			...
			var email = $(".mail_input").val(); //사용자가 입력한 이메일란
			var checkBox = $(".mail_check_input");//인증번호입력란.
			var boxWrap = $(".mail_check_input_box");
			var warnMsg = $(".mail_input_box_warn");  

			
			if(mailFormCheck(email)){
				warnMsg.html("이메일이 전송되었습니다. 인증번호를 확인해주세요.");
		...
		$(".mail_check_input").blur(function() {
			...
			var inputCode = $(".mail_check_input").val();//인증번호코드
			var checkResult = $("#mail_check_input_box_warn");//비교
